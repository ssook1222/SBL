    ...
    return(
        <>
            <Navbar collapseOnSelect expand="lg" variant="white">
                <Container>
                    <Navbar.Brand href="#home" id="sql_title_div"><h3 id="sql_title" 
                    ...
                    <Nav className="me-auto" style={{ margin:"auto" }} id="sql_index">
                        <Nav.Link id="sql1" href="#features" style={{ marginRight: '30px' }} >데이터베이스 입문</Nav.Link>
                        <Nav.Link id="sql2" href="#pricing" style={{ marginLeft: '30px' }}>SQL 문제풀이</Nav.Link>
                    </Nav>
                    </Navbar.Collapse>
                </Container>
            </Navbar>
